...
exports.modules = {
  ...
  /***/ 3468: /***/ (module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 4465: /***/ (module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 1831: /***/ (module, exports) => {
    ...
    function updateElements(type, components) {
      ...
      for (
        ...
        i < headCount;
        i++, j = (j == null ? void 0 : j.previousElementSibling) || null
      ) {
        var ref;
        if (
          (j == null
  ...
  /***/ 1551: /***/ (module, exports, __webpack_require__) => {
    'use strict';
    ...
    var _object_without_properties_loose =
      __webpack_require__(7273) /* ["default"] */.Z;
     ...
     */ const Link = /*#__PURE__*/ _react.default.forwardRef(
      function LinkComponent(props, forwardedRef) {
        ...
        const { href: href1, as } = _react.default.useMemo(() => {
          ...
          const [resolvedHref1, resolvedAs] = (0, _router).resolveHref(
            pagesRouter,
            hrefProp,
            true
          );
          return {
            href: resolvedHref1,
            as: asProp
              ? (0, _router).resolveHref(pagesRouter, asProp)
              : resolvedAs || resolvedHref1,
          };
        ...
        const setRef = _react.default.useCallback(
          ...
          [as, childRef, href1, resetVisible, setIntersectionRef]
        );
  ...
  /***/ 2700: /***/ (module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 6876: /***/ (module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 2497: /***/ (module, exports, __webpack_require__) => {
    'use strict';
    ...
    var _interop_require_default =
      __webpack_require__(2648) /* ["default"] */.Z;
    var _getAssetPathFromRoute = _interop_require_default(
  ...
  /***/ 3573: /***/ (module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 5407: /***/ (module, exports) => {
    ...
    function __unsafeCreateTrustedScriptURL(url) {
      var ref;
      return (
        ((ref = getPolicy()) == null ? void 0 : ref.createScriptURL(url)) || url
      );
    }
    if (
      (typeof exports.default === 'function' ||
  ...
  /***/ 9246: /***/ (module, exports, __webpack_require__) => {
    'use strict';
    ...
    function _withMiddlewareEffects() {
      _withMiddlewareEffects = _async_to_generator(function* (options) {
        ...
        try {
          ...
          const effect = yield getMiddlewareData(
            data.dataHref,
            data.response,
            options
          );
    ...
    function fetchNextData({
      ...
      const getData = (params) => {
        return fetchRetry(dataHref, isServerRender ? 3 : 1, {
          ...
          method:
            (ref1 = params == null ? void 0 : params.method) != null
              ? ref1
              : 'GET',
        })
          .then((response) => {
            ...
            return response.text().then((text) => {
              if (!response.ok) {
                ...
                if (!hasMiddleware && response.status === 404) {
                  var ref;
                  if (
                    (ref = tryToParseAsJSON(text)) == null
                      ? void 0
                      : ref.notFound
                  ) {
                    return {
    ...
    class Router {
      ...
      change(method, url, as, options, forcedScroll) {
        ...
        return _async_to_generator(function* () {
          ...
          if ((0, _isDynamic).isDynamicRoute(route)) {
            const parsedAs1 = (0, _parseRelativeUrl).parseRelativeUrl(
              resolvedAs
            );
          ...
          try {
            ...
            if (
              isQueryUpdating &&
              _this.pathname === '/_error' &&
              ((ref2 = self.__NEXT_DATA__.props) == null
                ? void 0
                : (ref3 = ref2.pageProps) == null
                ? void 0
                : ref3.statusCode) === 500 &&
              ((ref4 = routeInfo.props) == null ? void 0 : ref4.pageProps)
            ) {
            ...
            const isValidShallowRoute =
              options.shallow &&
              nextState.route ===
                ((_route = routeInfo.route) != null ? _route : route);
            var _scroll;
            const shouldScroll =
            ...
            if (
              isQueryUpdating &&
              (_this.pathname === '/404' || _this.pathname === '/_error')
            ) {
              var ref5, ref6, ref7;
              routeInfo = yield _this.getRouteInfo({
              ...
              if ('type' in routeInfo) {
                throw new Error(
                  `Unexpected middleware effect on ${_this.pathname}`
                );
              }
              if (
                _this.pathname === '/_error' &&
                ((ref5 = self.__NEXT_DATA__.props) == null
                  ? void 0
                  : (ref6 = ref5.pageProps) == null
                  ? void 0
                  : ref6.statusCode) === 500 &&
                ((ref7 = routeInfo.props) == null ? void 0 : ref7.pageProps)
              ) {
                // ensure statusCode is still correct for static 500 page
                // when updating query information
                routeInfo.props.pageProps.statusCode = 500;
      ...
      handleRouteInfoError(
        ...
        return _async_to_generator(function* () {
          ...
          try {
            let props;
            const { page: Component, styleSheets } = yield _this.fetchComponent(
              '/_error'
            );
            const routeInfo = {
              props,
        ...
        return _async_to_generator(function* () {
          ...
          try {
            ...
            if (
              (data == null
                ? void 0
                : (ref = data.effect) == null
                ? void 0
                : ref.type) === 'redirect-internal' ||
              (data == null
                ? void 0
                : (ref8 = data.effect) == null
                ? void 0
                : ref8.type) === 'redirect-external'
            ) {
              return data.effect;
            }
            if (
            ...
            const wasBailedPrefetch =
              data == null
                ? void 0
                : (ref10 = data.response) == null
                ? void 0
                : ref10.headers.get('x-middleware-skip');
        ...
        return _async_to_generator(function* () {
          ...
          if ((0, _isDynamic).isDynamicRoute(parsed.pathname)) {
            ...
            Object.assign(
              query,
              (0, _routeMatcher).getRouteMatcher(
                (0, _routeRegex).getRouteRegex(parsed.pathname)
              )((0, _parsePath).parsePath(asPath).pathname) || {}
            );
            if (!isMiddlewareMatch) {
              url = (0, _formatUrl).formatWithValidation(parsed);
            }
           ...
           */ if (
            (data == null ? void 0 : data.effect.type) === 'redirect-external'
          ) {
            return;
          }
          ...
          yield Promise.all([
            _this.pageLoader._isSsg(route).then((isSsg) => {
              return isSsg
                ? fetchNextData({
                    dataHref: (data == null ? void 0 : data.json)
                      ? data == null
                        ? void 0
                        : data.dataHref
                      : _this.pageLoader.getDataHref({
      ...
      constructor(
        ...
        this.onPopState = (e) => {
          ...
          if (
            ...
            pathname1 === (0, _addBasePath).addBasePath(this.pathname)
          ) {
            return;
          }
  ...
  /***/ 9423: /***/ (__unused_webpack_module, exports) => {
    'use strict';
