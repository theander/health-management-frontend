  ...
  [664],
  {
    ...
    1551: function (e, t, o) {
      ...
      var g = l.default.forwardRef(function (e, t) {
        ...
        var R = !1 !== _,
          S = l.default.useContext(i.RouterContext),
          ...
          D = l.default.useMemo(
            function () {
              ...
              var t = n(u.resolveHref(S, f, !0), 2),
                o = t[0],
                r = t[1];
              return { href: o, as: h ? u.resolveHref(S, h) : r || o };
            },
            [S, f, h]
          ),
          H = D.href,
          K = D.as,
          U = l.default.useRef(H),
          Z = l.default.useRef(K);
        x && (r = l.default.Children.only(o));
        var B = x ? r && 'object' == typeof r && r.ref : t,
          A = n(d.useIntersection({ rootMargin: '200px' }), 3),
          q = A[0],
          z = A[1],
          F = A[2],
          G = l.default.useCallback(
            function (e) {
              (Z.current !== K || U.current !== H) &&
                (F(), (Z.current = K), (U.current = H)),
                q(e),
                B &&
                  ('function' == typeof B
                    ? B(e)
        ...
        l.default.useEffect(
          function () {
            T && z && R && y(T, H, K, { locale: k });
          },
          [K, H, z, k, R, null == S ? void 0 : S.locale, T]
        );
        var J = {
          ref: G,
          onClick: function (e) {
              ...
              T &&
                ...
                (function (e, t, o, n, r, a, f, c, i, s) {
                  if (
                    ...
                    i ? l.default.startTransition(v) : v();
                  }
                })(e, T, H, K, m, C, j, k, N, R);
          },
        ...
        if (!x || M || ('a' === r.type && !('href' in r.props))) {
          var Q = void 0 !== k ? k : null == S ? void 0 : S.locale,
            V =
          ...
          J.href =
            V ||
            v.addBasePath(
              c.addLocale(K, Q, null == S ? void 0 : S.defaultLocale)
            );
        }
        return x
          ? l.default.cloneElement(r, J)
          : l.default.createElement('a', Object.assign({}, L, J), o);
      });
      (t.default = g),
        ('function' == typeof t.default ||
          ('object' == typeof t.default && null !== t.default)) &&
                ...
                if (l) {
                  if (!c && !s && v && v.tagName) {
                    ...
                    return (
                      ...
                      r.observe(v),
                      function () {
                        if ((i.delete(v), r.unobserve(v), 0 === i.size)) {
                  ...
                  var p = a.requestIdleCallback(function () {
                    return d(!0);
                  });
                  return function () {
                    return a.cancelIdleCallback(p);
                  };
                }
              },
              [v, c, o, t, s]
